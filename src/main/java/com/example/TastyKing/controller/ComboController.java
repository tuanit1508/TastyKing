...
public class ComboController {
    ...
    public ApiResponse<List<ComboFoodResponse>> getFoodInCombo(@PathVariable Long comboID) {
        List<ComboFoodResponse> foods = comboService.getFoodInCombo(comboID);
        return ApiResponse.<List<ComboFoodResponse>>builder()
                .result(foods)
                .build();
    }
}
